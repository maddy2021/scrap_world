...
class LazadaSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if(len(self.product_url_list)>0):
            # for p_url in self.product_url_list:
            yield scrapy.Request(url = "https://www.lazada.sg/products/prism-e65-4k-uhd-smart-digital-tv-hdr-zerobezel-design-4k-netflix-youtube-app-ips-panel-dolby-audio-digital-tv-ready-wifi-enabled-free-indoor-antenna-worth-35-i1010898153-s3698062714.html?search=1" ,callback = self.parse_item)
